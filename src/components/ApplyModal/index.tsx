  ...
  return (
    <Modal show={show} onHide={handleOnHide} dialogClassName={styles.modal}>
      <Form onSubmit={handleSubmit(onSubmit)}>
        <Container fluid className={`${styles.modalContainer} gx-0`}>
          <Row
            className={`d-grid justify-content-end gx-0 ${styles.closeIconContainer}`}
          >
            <ButtonXS
              onClick={handleOnHide}
              className="px-3 d-grid align-items-center"
            >
              <CloseIcon fill="#000" />
            </ButtonXS>
          </Row>
          <Container className="d-grid row-gap-4 px-4 px-lg-5 pb-5">

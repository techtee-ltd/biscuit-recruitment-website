      ...
      <Col xs={12} md={6}>
        <Row className="gap-4">
          <Row className="gap-1">
            ...
            <div>
              Our client is an established and highly successful investment firm
              that is headquarted in the US, with offices in both East and West
              Coast. They are now looking for an EA to provide utmost support to
              the brilliant MD based in the London office. We are looking for a
              splendid individual who possesses gravitas, agility and the
              ability to juggle multiple tasks at once whilst being a
              collaborative thought partner to the MD.
            </div>
          </Row>
